...
\begin{figure}[t]
\centering
	\includegraphics[height=6.5cm,keepaspectratio]{Figures/logo}
\end{figure}
...
=======
This document essentially follows the structure define by IEEET for RASD document (\textit{ ISO/IEC/IEEE 29148 dated Dec 2011}).
>>>>>>> Stashed changes
...
\end{itemize}
\newpage
\lstinputlisting[language=alloy]{/Users/nike/Desktop/MartinaNicheliniPeressini/Alloy.als}
\newpage
