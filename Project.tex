...
\subsection{External Interface Requirements}
	...
	\begin{figure}[!h]
	 	\centering
		\includegraphics[height=17cm,keepaspectratio]{Figures/Screen05}
		\caption{Dashboard page}
	\end{figure}\newpage
	\begin{figure}[!h]
	 	\centering
		\includegraphics[height=17cm,keepaspectratio]{Figures/Screen02}
		\caption{Disclamer page for event creation}
	\end{figure}\newpage
	
	\begin{figure}[!h]
	 	\centering
		\includegraphics[height=17cm,keepaspectratio]{Figures/Screen01}
		\caption{Event creation page}
	\end{figure}\newpage
	
	\begin{figure}[!h]
	 	\centering
		\includegraphics[height=17cm,keepaspectratio]{Figures/Screen03}
		\caption{Run's parameter modification page}
	\end{figure}\newpage
	
	\begin{figure}[!h]
	 	\centering
		\includegraphics[height=17cm,keepaspectratio]{Figures/Screen04}
	...
	Since all communications are going to pass through the internet,
	secured internet protocols are going to be adopted. \newline
	Moreover, data will be exchanged in multi-platform data formats 
	such as JSON or XML.
...
\begin{itemize}	
	...
	\item [G5] Allow users to monitor their performance during run 
	workouts.	
	\begin{itemize}
