...
Here we map each goal to the corresponding machine requirements and world domain assumptions that have to be made in order to reach it.
...
\item [G3] Allow users to have access to an overview of their data, including health parameters and p erformed activities
